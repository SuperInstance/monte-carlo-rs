...
Monte Carlo methods: uniform sampling, importance sampling, rejection sampling, MC integration, variance reduction
...
```bash
git clone https://github.com/SuperInstance/monte-carlo-rs
cd monte-carlo-rs
```
